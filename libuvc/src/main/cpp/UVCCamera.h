...
public:
	...
	int connect(int vid, int pid, int fd, int busnum, int devaddr, const char *usbfs, int videoIndex);
	int release();
	...
	int setCircleLightBrightness(int lightBrightness);
	int setCameraRotationDegrees(int rotationDegrees);
