package com.maxvision.uvcandroid.pair
...
import com.maxvision.uvcandroid.R
import com.maxvision.uvcandroid.databinding.FragmentMultiCameraBinding
...
class DemoMultiCameraFragment : MultiCameraFragment(), ICameraStateCallBack {
    ...
    override fun onCameraAttached(camera: MultiCameraClient.ICamera) {
        Log.i("TAG", "当前连接的摄像头：" + camera.device.productName)
