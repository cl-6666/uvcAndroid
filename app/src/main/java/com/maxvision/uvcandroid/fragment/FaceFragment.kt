...
import com.maxvision.uvcandroid.databinding.FragmentFaceBinding
 ...
 * desc：
 */
open class FaceFragment : Fragment(), ICameraStateCallBack {
    private lateinit var irisBinding: FragmentFaceBinding
    ...
    override fun onCreateView(
        ...
        irisBinding = FragmentFaceBinding.inflate(inflater, container, false)
...
//    private var productName = "Face_Camera" //Iris_Collector 红外   USB2.0 Camera 可见光 Face_Camera
    private var productName = "UVC RGB"
...
//            .create()
    ...
    private fun getCameraView(): IAspectRatio {
        val textureView = AspectRatioTextureView2(requireContext())
...
//            }
    ...
    protected fun openCamera(st: IAspectRatio? = null) {
        when (st) {
            ...
            getCurrentCamera()?.setCameraStateCallBack(this@FaceFragment)
